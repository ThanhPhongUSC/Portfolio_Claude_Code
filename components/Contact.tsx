...
import { contact, contactLinks, type ContactLink } from "@/data/profile";

/** Icon for each kind of contact link (keeps the markup below tidy). */
const icons: Record<ContactLink["kind"], JSX.Element> = {
  email: (
    <svg
      width="18"
      height="18"
